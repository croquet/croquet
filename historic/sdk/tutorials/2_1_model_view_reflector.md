...
**Snapshots** are archived copies of a model's state. Devices periodically take snapshots of the model state and save it to the cloud. When a new user joins a session, it can synch with the other users by loading one of these snapshots.
