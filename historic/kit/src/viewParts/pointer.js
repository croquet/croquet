...
export default class PointerViewPart extends ViewPart {
    ...
    onMouseDown() {
        if (this.hoveredViewPart) {
            ...
            if (this.userDraggingPlane) {
                this.userDraggingPlane.setFromNormalAndCoplanarPoint(this.userDraggingPlane.normal, this.hoverPoint);
            }
        }
    }
    ...
    onRequestTrackPlane(request) {
        ...
        if (this.dragStartPoint) {
            this.userDraggingPlane.setFromNormalAndCoplanarPoint(this.userDraggingPlane.normal, this.dragStartPoint);
        }
    }
}
