...
function tag(name, formattingProperty) {
...
function value(type, styleProperty, formattingProperty, transformValue) {
  return function(node, formatting) {
...
function attrValue(styleProperty, formattingProperty, transformValue) {
  return value('attributes', styleProperty, formattingProperty, transformValue);
};

function styleValue(styleProperty, formattingProperty, transformValue) {
  return value('style', styleProperty, formattingProperty, transformValue);
};

function styleFlag(styleProperty, styleValue, formattingProperty) {
  return function(node, formatting) {
...
export function parse(html, classes) {
  ...
  var cons = per(consolidate()).into(result);
