...
export class Session {
     ...
     * @param {Object?} parameters.viewInfo - data passed as additional payload to the [`"view-join"` event]{@link event:view-join} and [`"view-exit"` event]{@link event:view-exit} (no default)
    ...
    static async join_impl(parameters) {
        ...
        const SESSION_PARAMS = ['name', 'password', 'apiKey', 'appId', 'tps', 'autoSleep', 'heraldUrl', 'rejoinLimit', 'eventRateLimit', 'optionsFromUrl', 'persistentIdOptions', 'viewOptions', 'viewInfo', 'viewIdDebugSuffix', 'hashOverride', 'location', 'flags', 'progressReporter'];
