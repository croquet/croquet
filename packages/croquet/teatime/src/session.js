...
export class Session {
     ...
     * @param {Object?} parameters.viewInfo - data passed as additional payload to the [`"view-join"`]{@link event:view-join} and [`"view-exit"`]{@link event:view-exit} events (no default)
