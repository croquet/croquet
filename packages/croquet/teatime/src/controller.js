...
import UploadWorkerFactory from "web-worker:./upload";      // generated by webpack
...
const CROQUET_VERSION = process.env.CROQUET_VERSION || "<unknown>";

// codepen cannot deal with styled console output
if (window.location.hostname.match(/co?de?pe?n\.io/)) console.log("Croquet " + CROQUET_VERSION);
...
export default class Controller {
    ...
    reset() {
        if (window.CROQUETVM === this.vm) delete window.CROQUETVM;
        /** @type {VirtualMachine} */
        this.vm = null;
...
// this.stats = {};
    ...
    async persistenceVoting(vmTime, persistTime, our_hash, our_ms) {
        ...
        const tally = await this.sendTutti(vmTime, "persist", ourVote);
